...
$count = 0;
// $list =[];
// $sql = "SELECT idSpec from speciality WHERE idSpec IN (SELECT idSpec FROM user_speciality WHERE user_speciality.idSpec=speciality.id";
// $query = $dbConnect->prepare($sql);
// $query->execute();
// foreach ($query->fetchAll() as $tabValues) {
