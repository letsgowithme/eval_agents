...
<tr>
  ...
  <td class="text-center px-4 py-2"><?php echo  $hideoutCode ?></td>
  <td class="text-center px-4 py-2"><?php echo $hideoutAddress ?></td>
  ...
  <td class="text-center px-4 py-2"><?php echo $country ?></td>
                ...
                <td class="text-center">
                  <a class="btn btn-success" href="../update/hideout_update.php?id=<?php echo $id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                    ...
                    <button  type="button" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $count ?>" class="btn btn-danger" href="../update/delete.php?idHideout=<?php $row["id"] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
