...
<select name="targets[]" id="target" multiple="multiple" class="fs-5 pb--2 pe-2"  style="min-width: 330px;">
    <!-- <option>Choisir:</option> -->
<?php 
$sql = "SELECT * FROM `person` WHERE `userType`= 'target' ORDER BY `lastname` ASC";
