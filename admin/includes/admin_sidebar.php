        ...
        <div class="p-2" style="background-color:  #29292b;">
          ...
          <ul class="nav nav-pills flex-column mt-2">
            ...
            <li class="nav-item py-2 py-sm-0">
              ...
              <i class="fa fa-person-chalkboard"></i><span class="fs-5 ms-3 d-none d-sm-inline">Spécialités</span>
              </a>
            </li>
            <li class="nav-item py-2 py-sm-0">
              <a href="../lists/missionTypes.php" class="nav-link text-white <?php echo !empty($missionTypes)?"active":"" ?>">
              <i class="fa-solid fa-camera-retro"></i></i><span class="fs-5 ms-3 d-none d-sm-inline">Type de mission</span>
              </a>
            </li>
