      ...
      <div class="col-auto col-md-4 col-lg-2 min-vh-100 d-flex flex-column justify-content-between" style="background-color: #404144;">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">   <ul class="">
            <li><a class="dropdown-item py-2 py-sm" href="../missions.php">Missions</a></li>
            <li><a class="dropdown-item py-2 py-sm" href="lists/usersAll.php">Utilisateurs</a></li>
            <li><a class="dropdown-item py-2 py-sm" href="lists/agents.php">Agents</a></li>
            <li><a class="dropdown-item py-2 py-sm" href="lists/targets.php">Cibles</a></li>
            <li><a class="dropdown-item py-2 py-sm" href="lists/contacts.php">Contacts</a></li>
            <li><a class="dropdown-item py-2 py-sm" href="lists/hideouts.php">Planques</a></li>
