...
<h1>Ajouter une mission</h1>  
        ...
        <form class="form" action="mission_new.php" method="post">
          <div class="mb-3">
            ...
            <input type="text" class="form-control w-50" name="title" id="title" value="" required>
          </div>
         ...
         <?php include_once "../lists/statuses.php"; ?>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control w-50" name="codeName" id="codeName" value="" required>
          </div>
          
         <!-- ************missionType de La mission************** -->
           <label for="missionType" class="form-label fw-bold">Type de mission</label>
           <select class="form-control w-50" name="mmt_missionTypeId" required>
           <?php 
