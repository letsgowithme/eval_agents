...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <a href="#" class="nav-link  <?php echo !empty($admin)?"active":"" ?>" aria-current="page">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
        <li><a class="dropdown-item" href="lists/usersAll.php">Utilisateurs</a></li>
        <li><a class="dropdown-item" href="../missions.php">Missions</a></li>
        <li><a class="dropdown-item" href="new/user_new.php">Créer l'utilisateur</a></li>
        <li><hr class="dropdown-divider"></li>
...
<hr id="monhr" style="width: 1100px!important; margin-left: 15px;">
<?php include "includes/admin_footer.php"; ?></div>
</div>